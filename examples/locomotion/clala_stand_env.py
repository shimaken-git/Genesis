...
class ClalaEnv:
    ...
    def _resample_commands(self, envs_idx):
        self.commands[envs_idx, 0] = gs_rand_float(*self.command_cfg["body_angle_x_range"], (len(envs_idx),), self.device)
        self.commands[envs_idx, 1] = gs_rand_float(*self.command_cfg["body_angle_y_range"], (len(envs_idx),), self.device)
        self.commands[envs_idx, 2] = gs_rand_float(*self.command_cfg["body_height_range"], (len(envs_idx),), self.device)
    ...
    def _reward_base_height(self):
        ...
        return torch.square(self.base_pos[:, 2] - (self.reward_cfg["base_height_target"] + self.commands[:, 2]))
